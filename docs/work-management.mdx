...
Slack, Telegram, and Discord gateway turns can default reminders and recurring
check-ins to the current chat. Terminal commands require either `--provider` and
