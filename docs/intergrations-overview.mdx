...
**Communication.** OpenSRE delivers investigation reports where your team already works. Connect [Slack](/slack).
...
| --- | --- |
| **Observability** | [Honeycomb](/honeycomb), [Coralogix](/coralogix), [Sentry](/sentry) |
