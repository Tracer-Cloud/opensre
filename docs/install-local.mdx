...
For platform requirements, see [macOS](/environments/macos), [Linux](/environments/linux-local), or [Windows](/environments/windows-local). For a container, see [Docker](/environments/docker).
