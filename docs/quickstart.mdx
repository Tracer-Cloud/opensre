...
<Steps>
  ...
  <Step title="Setup">
    Run first-run setup to create or sign in to your OpenSRE account. From a source checkout, prefix commands in this guide with `uv run` (for example, `uv run opensre setup`).
