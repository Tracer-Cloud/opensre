...
Every launch opens a demo picker before the prompt. The recommended option
analyzes CI/CD performance on a real repository (`cicd-analytics-demo`). Escape
or "Or type your own answer..." continue into the shell; type `/demo` to open
it again. See [CI/CD analytics demo](/cicd-analytics-demo).
