...
from app.tools.tool_actions.DataDogLogsTool import _ERROR_KEYWORDS
from app.tools.tool_actions.DataDogLogsTool._client import make_async_client
...
class DataDogContextTool(BaseTool):
...
fetch_datadog_context = DataDogContextTool()
