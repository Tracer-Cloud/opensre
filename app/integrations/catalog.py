        ...
        if key in ("grafana", "grafana_local"):
            ...
            if account_identifier and token:
                resolved["snowflake"] = {
                    ...
                    "max_results": max(1, min(int(credentials.get("max_results", 50)) or 50, 200)),
                    "integration_id": integration.get("id", ""),
                }
            ...
            if workspace_id and access_token:
                resolved["azure"] = {
                    ...
                    "max_results": max(1, min(int(credentials.get("max_results", 100)) or 100, 500)),
                    "integration_id": integration.get("id", ""),
                }
...
def load_env_integrations() -> list[dict[str, Any]]:
    ...
    # Snowflake integration from environment
    snowflake_account = (
    ...
    # Azure Log Analytics integration from environment
    ...
    # OpenObserve integration from environment
    ...
    # OpenSearch integration from environment
