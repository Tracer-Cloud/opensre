...
def query_loki_logs(execution_run_id: str) -> list[dict]:
    ...
    try:
        query = f'{{service_name="cloudwatch-demo"}} |= "{execution_run_id}"'
...
def run_pipeline() -> str:
    ...
    try:
        ...
        # Expected failure - extract execution_run_id from telemetry context
        # For this test, we'll just generate a UUID and check telemetry was sent
