...
Prebuilt Linux binaries require **glibc 2.35+** (Ubuntu 22.04+ or a comparable distribution) and do not run on Alpine Linux. On an older or musl-based Linux system, [install from source](SETUP.md#quick-setup-all-platforms) instead.
